    ...
    <div className='w-full py-[4rem] px-4 bg-white'>
      ...
      <div className='max-w-[1240px]  mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-4'>
          ...
          <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <button className='bg-[#3859a5] text-[#ffffff] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Solicitar</button>
          </div>
          <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <button className='bg-[#277dc0] text-white w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Solicitar</button>
          </div>
          <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              <img className='w-20 mx-auto mt-[3rem]' src={Triple} alt="/" />
