...
const Footer = () => {
  ...
  return (
    <>
      <footer className=" bg-[#0a071c] md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
        <div className='flex items-center'>
          <img className='w-[2.5rem] text-3xl font-bold text-[#00df9a]' src={Logo} alt="Sparkle Group Logo" />
          <h1 className='w-full ml-2 text-2xl font-bold text-[#ffffff]'>Spark Group</h1>
        </div>
        ...
        <div className="flex sm:justify-center space-x-6">
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/grupo_spark/?next=%2F" className="text-gray-500 hover:text-gray-900">
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {/* Tik Tok */}
          <a href="https://www.tiktok.com/@grupospark" className="text-gray-500 hover:text-gray-900">
            <FaTiktok />
          </a>


          <a href="https://api.whatsapp.com/message/EH45EKR7CQL6H1?autoload=1&app_absent=0" className="text-gray-500 hover:text-gray-900">
            <FaWhatsapp size={20}/>
          </a>
        {/*   
          <a href="#" className="text-gray-500 hover:text-gray-900">
      ...
      <p className="text-center text-sm text-gray-500 my-10">
        &copy; 2023 <a href="#" className="hover:underline" target="_blank">Spark Group</a>. All rights reserved.
      </p>
    </>
  )
